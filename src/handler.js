...
const addNewBookHandler = (request, h) => {
  ...
  // Validasi jika menambahkan buku tanpa ada nama
  if (name === undefined) {
...
module.exports = { addNewBookHandler, getAllBookHandler, getBookByIdHandler, updateBookByIdHandler, deleteBookByIdHandler };